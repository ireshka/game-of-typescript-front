...
export const BoardApiContext = React.createContext<{api: typeof GameOfLife} | undefined>(undefined);
...
export const BoardApiProvider = ({children}: BoardApiProviderProps) => {
  ...
  return (
    <BoardApiContext.Provider value={value}>{children}</BoardApiContext.Provider>
  )
}
